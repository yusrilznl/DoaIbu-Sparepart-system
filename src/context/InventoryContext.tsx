...
const mapDbToSparePart = (row: any): SparePart => ({
  ...
  hargaShopee: row.harga_shopee !== undefined && row.harga_shopee !== null ? Number(row.harga_shopee) : (row.hargaShopee !== undefined ? Number(row.hargaShopee) : undefined),
  adminFeeShopeePercent: row.admin_fee_shopee_percent !== undefined && row.admin_fee_shopee_percent !== null ? Number(row.admin_fee_shopee_percent) : (row.adminFeeShopeePercent !== undefined ? Number(row.adminFeeShopeePercent) : 8.5),
  hargaTokopedia: row.harga_tokopedia !== undefined && row.harga_tokopedia !== null ? Number(row.harga_tokopedia) : (row.hargaTokopedia !== undefined ? Number(row.hargaTokopedia) : undefined),
  adminFeeTokopediaPercent: row.admin_fee_tokopedia_percent !== undefined && row.admin_fee_tokopedia_percent !== null ? Number(row.admin_fee_tokopedia_percent) : (row.adminFeeTokopediaPercent !== undefined ? Number(row.adminFeeTokopediaPercent) : 8.0),
  beratGram: row.berat_gram !== undefined && row.berat_gram !== null ? Number(row.berat_gram) : (row.beratGram !== undefined ? Number(row.beratGram) : undefined),
  tinggiCm: row.tinggi_cm !== undefined && row.tinggi_cm !== null ? Number(row.tinggi_cm) : (row.tinggiCm !== undefined ? Number(row.tinggiCm) : undefined),
  lebarCm: row.lebar_cm !== undefined && row.lebar_cm !== null ? Number(row.lebar_cm) : (row.lebarCm !== undefined ? Number(row.lebarCm) : undefined),
  panjangCm: row.panjang_cm !== undefined && row.panjang_cm !== null ? Number(row.panjang_cm) : (row.panjangCm !== undefined ? Number(row.panjangCm) : undefined),
...
const mapSparePartToDb = (part: any) => {
  ...
  const dbPayload: any = {
    ...
    harga_shopee: Number(part.hargaShopee ?? part.hargaJual ?? 0),
    admin_fee_shopee_percent: Number(part.adminFeeShopeePercent ?? 8.5),
    harga_tokopedia: Number(part.hargaTokopedia ?? part.hargaJual ?? 0),
    admin_fee_tokopedia_percent: Number(part.adminFeeTokopediaPercent ?? 8.0),
    berat_gram: Number(part.beratGram ?? 0),
    tinggi_cm: Number(part.tinggiCm ?? 0),
    lebar_cm: Number(part.lebarCm ?? 0),
    panjang_cm: Number(part.panjangCm ?? 0),
